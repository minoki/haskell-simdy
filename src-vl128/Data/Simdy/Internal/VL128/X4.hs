...
instance SelectableF X4 Double where
  ...
  {-# INLINE selectF #-}
instance (i0 < 4, i1 < 4, i2 < 4, i3 < 4, ShuffleMany DoubleX2# [i0, i1], ShuffleMany DoubleX2# [i2, i3]) => UnaryShuffle [i0, i1, i2, i3] X4 Double where
  ...
  {-# INLINE unaryShuffle #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, ShuffleMany DoubleX2# [i0, i1], ShuffleMany DoubleX2# [i2, i3]) => BinaryShuffle [i0, i1, i2, i3] X4 Double where
...
instance SelectableF X4 Int64 where
  ...
  {-# INLINE selectF #-}
instance (i0 < 4, i1 < 4, i2 < 4, i3 < 4, ShuffleMany Int64X2# [i0, i1], ShuffleMany Int64X2# [i2, i3]) => UnaryShuffle [i0, i1, i2, i3] X4 Int64 where
  ...
  {-# INLINE unaryShuffle #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, ShuffleMany Int64X2# [i0, i1], ShuffleMany Int64X2# [i2, i3]) => BinaryShuffle [i0, i1, i2, i3] X4 Int64 where
...
instance SelectableF X4 Word64 where
  ...
  {-# INLINE selectF #-}
instance (i0 < 4, i1 < 4, i2 < 4, i3 < 4, ShuffleMany Word64X2# [i0, i1], ShuffleMany Word64X2# [i2, i3]) => UnaryShuffle [i0, i1, i2, i3] X4 Word64 where
  ...
  {-# INLINE unaryShuffle #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, ShuffleMany Word64X2# [i0, i1], ShuffleMany Word64X2# [i2, i3]) => BinaryShuffle [i0, i1, i2, i3] X4 Word64 where
