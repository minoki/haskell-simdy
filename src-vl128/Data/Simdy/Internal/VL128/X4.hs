...
instance SelectableF X4 Float where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany FloatX4# indices) => UnaryShuffleT indices X4 Float where
  unaryShuffle (MkFloatX4 x) = MkFloatX4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany FloatX4# indices) => BinaryShuffleT indices X4 Float where
...
data instance X4 Double = MkDoubleX4WithVec128 DoubleX2# DoubleX2#
instance PackX4 X4 Double where
  mkX4 (D# x0) (D# x1) (D# x2) (D# x3) = MkDoubleX4WithVec128 (packDoubleX2# (# x0, x1 #)) (packDoubleX2# (# x2, x3 #))
  unpackX4 (MkDoubleX4WithVec128 v0 v1) = case unpackDoubleX2# v0 of (# x0, x1 #) -> case unpackDoubleX2# v1 of (# x2, x3 #) -> (D# x0, D# x1, D# x2, D# x3)
  {-# INLINE mkX4 #-}
  {-# INLINE unpackX4 #-}
instance Broadcast X4 Double where
  broadcast (D# x) = let !v = broadcastDoubleX2# x in MkDoubleX4WithVec128 v v
  {-# INLINE broadcast #-}
instance SelectableF X4 Double where
  selectF (MkBoolX4 !cond) (MkDoubleX4WithVec128 x0 x1) (MkDoubleX4WithVec128 y0 y1) = MkDoubleX4WithVec128 (selectDoubleX2# (cond `unsafeShiftR` 0) x0 y0) (selectDoubleX2# (cond `unsafeShiftR` 2) x1 y1)
  {-# INLINE selectF #-}
instance (i0 < 4, i1 < 4, i2 < 4, i3 < 4, ShuffleMany DoubleX2# [i0, i1], ShuffleMany DoubleX2# [i2, i3]) => UnaryShuffleT [i0, i1, i2, i3] X4 Double where
  unaryShuffle (MkDoubleX4WithVec128 x0 x1) = let { sources = \case { 0 -> x0; _ -> x1 } } in MkDoubleX4WithVec128 (shuffleMany# @_ @_ @[i0, i1] sources) (shuffleMany# @_ @_ @[i2, i3] sources)
  {-# INLINE unaryShuffle #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, ShuffleMany DoubleX2# [i0, i1], ShuffleMany DoubleX2# [i2, i3]) => BinaryShuffleT [i0, i1, i2, i3] X4 Double where
  binaryShuffle (MkDoubleX4WithVec128 x0 x1) (MkDoubleX4WithVec128 x2 x3) = let { sources = \case { 0 -> x0; 1 -> x1; 2 -> x2; _ -> x3 } } in MkDoubleX4WithVec128 (shuffleMany# @_ @_ @[i0, i1] sources) (shuffleMany# @_ @_ @[i2, i3] sources)
  {-# INLINE binaryShuffle #-}
instance EquatableF X4 Double where
  eqF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (eqDoubleX2# u0 v0)) .|. (fromIntegral (eqDoubleX2# u1 v1) `unsafeShiftL` 2)
  {-# INLINE eqF #-}
instance OrderedF X4 Double where
  ltF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (ltDoubleX2# u0 v0)) .|. (fromIntegral (ltDoubleX2# u1 v1) `unsafeShiftL` 2)
  leF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (leDoubleX2# u0 v0)) .|. (fromIntegral (leDoubleX2# u1 v1) `unsafeShiftL` 2)
  gtF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (gtDoubleX2# u0 v0)) .|. (fromIntegral (gtDoubleX2# u1 v1) `unsafeShiftL` 2)
  geF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (geDoubleX2# u0 v0)) .|. (fromIntegral (geDoubleX2# u1 v1) `unsafeShiftL` 2)
  {-# INLINE ltF #-}
  {-# INLINE leF #-}
  {-# INLINE gtF #-}
  {-# INLINE geF #-}
instance MinMaxF X4 Double where
  minF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (minimumDoubleX2# u0 v0) (minimumDoubleX2# u1 v1)
  maxF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (maximumDoubleX2# u0 v0) (maximumDoubleX2# u1 v1)
  minimumNumberF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (minimumNumberDoubleX2# u0 v0) (minimumNumberDoubleX2# u1 v1)
  maximumNumberF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (maximumNumberDoubleX2# u0 v0) (maximumNumberDoubleX2# u1 v1)
  {-# INLINE minF #-}
  {-# INLINE maxF #-}
  {-# INLINE minimumNumberF #-}
  {-# INLINE maximumNumberF #-}
negateX4Double :: X4 Double -> X4 Double
negateX4Double (MkDoubleX4WithVec128 u0 u1) = MkDoubleX4WithVec128 (negateDoubleX2# u0) (negateDoubleX2# u1)
#if defined(USE_FMA)
...
instance NumF X4 Double where
  plusF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (plusDoubleX2# u0 v0) (plusDoubleX2# u1 v1)
  minusF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (minusDoubleX2# u0 v0) (minusDoubleX2# u1 v1)
  timesF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (timesDoubleX2# u0 v0) (timesDoubleX2# u1 v1)
  negateF = negateX4Double
  absF (MkDoubleX4WithVec128 u0 u1) = MkDoubleX4WithVec128 (absDoubleX2# u0) (absDoubleX2# u1)
  {-# INLINE plusF #-}
  {-# INLINE minusF #-}
  {-# INLINE timesF #-}
  {-# INLINE negateF #-}
...
instance FractionalF X4 Double where
  divideF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) = MkDoubleX4WithVec128 (divideDoubleX2# u0 v0) (divideDoubleX2# u1 v1)
  {-# INLINE divideF #-}
instance FloatingF X4 Double where
  sqrtF (MkDoubleX4WithVec128 u0 u1) = MkDoubleX4WithVec128 (sqrtDoubleX2# u0) (sqrtDoubleX2# u1)
  {-# INLINE sqrtF #-}
instance HasFMA => FusedMultiplyAddF X4 Double where
#if defined(USE_FMA)
  fusedMultiplyAddF (MkDoubleX4WithVec128 u0 u1) (MkDoubleX4WithVec128 v0 v1) (MkDoubleX4WithVec128 w0 w1) = MkDoubleX4WithVec128 (fmaddDoubleX2# u0 v0 w0) (fmaddDoubleX2# u1 v1 w1)
  {-# INLINE fusedMultiplyAddF #-}
#else
  fusedMultiplyAddF _ _ _ = fmaIsDisabled
#endif
...
instance MultiPrim X4 Double where
  ...
  readByteArraySIMD# mba i s0 = case readDoubleArrayAsDoubleX2# mba i s0 of (# s1, v0 #) -> case readDoubleArrayAsDoubleX2# mba (i +# 2#) s1 of (# s2, v1 #) -> (# s2, MkDoubleX4WithVec128 v0 v1 #)
  writeByteArraySIMD# mba i (MkDoubleX4WithVec128 v0 v1) s0 = case writeDoubleArrayAsDoubleX2# mba i v0 s0 of s1 -> writeDoubleArrayAsDoubleX2# mba (i +# 2#) v1 s1
  {-# INLINE indexByteArraySIMD# #-}
  {-# INLINE readByteArraySIMD# #-}
  {-# INLINE writeByteArraySIMD# #-}
instance MultiStorable X4 Double where
  peekElemOffSIMD (Ptr addr) (I# i) = IO (\s0 -> case readDoubleOffAddrAsDoubleX2# addr i s0 of (# s1, v0 #) -> case readDoubleOffAddrAsDoubleX2# addr (i +# 2#) s1 of (# s2, v1 #) -> (# s2, MkDoubleX4WithVec128 v0 v1 #))
...
instance SelectableF X4 Int8 where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany Int8X16# indices) => UnaryShuffleT indices X4 Int8 where
  unaryShuffle (MkInt8X4 x) = MkInt8X4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany Int8X16# indices) => BinaryShuffleT indices X4 Int8 where
...
instance SelectableF X4 Int16 where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany Int16X8# indices) => UnaryShuffleT indices X4 Int16 where
  unaryShuffle (MkInt16X4 x) = MkInt16X4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany Int16X8# indices) => BinaryShuffleT indices X4 Int16 where
...
instance SelectableF X4 Int32 where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany Int32X4# indices) => UnaryShuffleT indices X4 Int32 where
  unaryShuffle (MkInt32X4 x) = MkInt32X4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany Int32X4# indices) => BinaryShuffleT indices X4 Int32 where
...
instance MultiStorable X4 Int32 where
  ...
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
data instance X4 Int64 = MkInt64X4WithVec128 Int64X2# Int64X2#
instance PackX4 X4 Int64 where
  mkX4 (I64# x0) (I64# x1) (I64# x2) (I64# x3) = MkInt64X4WithVec128 (packInt64X2# (# x0, x1 #)) (packInt64X2# (# x2, x3 #))
  unpackX4 (MkInt64X4WithVec128 v0 v1) = case unpackInt64X2# v0 of (# x0, x1 #) -> case unpackInt64X2# v1 of (# x2, x3 #) -> (I64# x0, I64# x1, I64# x2, I64# x3)
  {-# INLINE mkX4 #-}
  {-# INLINE unpackX4 #-}
instance Broadcast X4 Int64 where
  broadcast (I64# x) = let !v = broadcastInt64X2# x in MkInt64X4WithVec128 v v
  {-# INLINE broadcast #-}
instance SelectableF X4 Int64 where
  selectF (MkBoolX4 !cond) (MkInt64X4WithVec128 x0 x1) (MkInt64X4WithVec128 y0 y1) = MkInt64X4WithVec128 (selectInt64X2# (cond `unsafeShiftR` 0) x0 y0) (selectInt64X2# (cond `unsafeShiftR` 2) x1 y1)
  {-# INLINE selectF #-}
instance (i0 < 4, i1 < 4, i2 < 4, i3 < 4, ShuffleMany Int64X2# [i0, i1], ShuffleMany Int64X2# [i2, i3]) => UnaryShuffleT [i0, i1, i2, i3] X4 Int64 where
  unaryShuffle (MkInt64X4WithVec128 x0 x1) = let { sources = \case { 0 -> x0; _ -> x1 } } in MkInt64X4WithVec128 (shuffleMany# @_ @_ @[i0, i1] sources) (shuffleMany# @_ @_ @[i2, i3] sources)
  {-# INLINE unaryShuffle #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, ShuffleMany Int64X2# [i0, i1], ShuffleMany Int64X2# [i2, i3]) => BinaryShuffleT [i0, i1, i2, i3] X4 Int64 where
  binaryShuffle (MkInt64X4WithVec128 x0 x1) (MkInt64X4WithVec128 x2 x3) = let { sources = \case { 0 -> x0; 1 -> x1; 2 -> x2; _ -> x3 } } in MkInt64X4WithVec128 (shuffleMany# @_ @_ @[i0, i1] sources) (shuffleMany# @_ @_ @[i2, i3] sources)
  {-# INLINE binaryShuffle #-}
instance EquatableF X4 Int64 where
  eqF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (eqInt64X2# u0 v0)) .|. (fromIntegral (eqInt64X2# u1 v1) `unsafeShiftL` 2)
  {-# INLINE eqF #-}
instance OrderedF X4 Int64 where
  ltF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (ltInt64X2# u0 v0)) .|. (fromIntegral (ltInt64X2# u1 v1) `unsafeShiftL` 2)
  leF !x !y = complementF (ltF y x)
  gtF !x !y = ltF y x
  geF !x !y = complementF (ltF x y)
  {-# INLINE ltF #-}
...
instance MinMaxF X4 Int64 where
  minF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (minInt64X2# u0 v0) (minInt64X2# u1 v1)
  maxF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (maxInt64X2# u0 v0) (maxInt64X2# u1 v1)
  minimumNumberF = minF
  maximumNumberF = maxF
  {-# INLINE minF #-}
  {-# INLINE maxF #-}
...
instance NumF X4 Int64 where
  plusF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (plusInt64X2# u0 v0) (plusInt64X2# u1 v1)
  minusF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (minusInt64X2# u0 v0) (minusInt64X2# u1 v1)
  timesF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (timesInt64X2# u0 v0) (timesInt64X2# u1 v1)
  negateF (MkInt64X4WithVec128 u0 u1) = MkInt64X4WithVec128 (negateInt64X2# u0) (negateInt64X2# u1)
  absF (MkInt64X4WithVec128 u0 u1) = MkInt64X4WithVec128 (absInt64X2# u0) (absInt64X2# u1)
  {-# INLINE plusF #-}
  {-# INLINE minusF #-}
  {-# INLINE timesF #-}
  {-# INLINE negateF #-}
...
instance BooleanF X4 Int64 where
  andF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (andInt64X2# u0 v0) (andInt64X2# u1 v1)
  orF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (orInt64X2# u0 v0) (orInt64X2# u1 v1)
  xorF (MkInt64X4WithVec128 u0 u1) (MkInt64X4WithVec128 v0 v1) = MkInt64X4WithVec128 (xorInt64X2# u0 v0) (xorInt64X2# u1 v1)
  complementF (MkInt64X4WithVec128 u0 u1) = MkInt64X4WithVec128 (complementInt64X2# u0) (complementInt64X2# u1)
  {-# INLINE andF #-}
  {-# INLINE orF #-}
  {-# INLINE xorF #-}
  {-# INLINE complementF #-}
instance BitShiftF X4 Int64 where
  shiftLF (MkInt64X4WithVec128 u0 u1) (I# i) = MkInt64X4WithVec128 (shiftLInt64X2# u0 i) (shiftLInt64X2# u1 i)
  shiftRF (MkInt64X4WithVec128 u0 u1) (I# i) = MkInt64X4WithVec128 (shiftRInt64X2# u0 i) (shiftRInt64X2# u1 i)
  {-# INLINE shiftLF #-}
  {-# INLINE shiftRF #-}
...
instance MultiPrim X4 Int64 where
  ...
  readByteArraySIMD# mba i s0 = case readInt64ArrayAsInt64X2# mba i s0 of (# s1, v0 #) -> case readInt64ArrayAsInt64X2# mba (i +# 2#) s1 of (# s2, v1 #) -> (# s2, MkInt64X4WithVec128 v0 v1 #)
  writeByteArraySIMD# mba i (MkInt64X4WithVec128 v0 v1) s0 = case writeInt64ArrayAsInt64X2# mba i v0 s0 of s1 -> writeInt64ArrayAsInt64X2# mba (i +# 2#) v1 s1
  {-# INLINE indexByteArraySIMD# #-}
  {-# INLINE readByteArraySIMD# #-}
  {-# INLINE writeByteArraySIMD# #-}
instance MultiStorable X4 Int64 where
  peekElemOffSIMD (Ptr addr) (I# i) = IO (\s0 -> case readInt64OffAddrAsInt64X2# addr i s0 of (# s1, v0 #) -> case readInt64OffAddrAsInt64X2# addr (i +# 2#) s1 of (# s2, v1 #) -> (# s2, MkInt64X4WithVec128 v0 v1 #))
  pokeElemOffSIMD (Ptr addr) (I# i) (MkInt64X4WithVec128 v0 v1) = IO (\s0 -> case writeInt64OffAddrAsInt64X2# addr i v0 s0 of s1 -> case writeInt64OffAddrAsInt64X2# addr (i +# 2#) v1 s1 of s2 -> (# s2, () #))
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
...
instance SelectableF X4 Word8 where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany Word8X16# indices) => UnaryShuffleT indices X4 Word8 where
  unaryShuffle (MkWord8X4 x) = MkWord8X4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany Word8X16# indices) => BinaryShuffleT indices X4 Word8 where
...
instance SelectableF X4 Word16 where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany Word16X8# indices) => UnaryShuffleT indices X4 Word16 where
  unaryShuffle (MkWord16X4 x) = MkWord16X4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany Word16X8# indices) => BinaryShuffleT indices X4 Word16 where
...
instance SelectableF X4 Word32 where
  ...
  {-# INLINE selectF #-}
instance (AllLessThan indices 4, ShuffleMany Word32X4# indices) => UnaryShuffleT indices X4 Word32 where
  unaryShuffle (MkWord32X4 x) = MkWord32X4 (shuffleMany# @_ @_ @indices (\_ -> x))
  {-# INLINE unaryShuffle #-}
instance (AllLessThan indices 8, ShuffleMany Word32X4# indices) => BinaryShuffleT indices X4 Word32 where
...
instance MultiStorable X4 Word32 where
  ...
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
data instance X4 Word64 = MkWord64X4WithVec128 Word64X2# Word64X2#
instance PackX4 X4 Word64 where
  mkX4 (W64# x0) (W64# x1) (W64# x2) (W64# x3) = MkWord64X4WithVec128 (packWord64X2# (# x0, x1 #)) (packWord64X2# (# x2, x3 #))
  unpackX4 (MkWord64X4WithVec128 v0 v1) = case unpackWord64X2# v0 of (# x0, x1 #) -> case unpackWord64X2# v1 of (# x2, x3 #) -> (W64# x0, W64# x1, W64# x2, W64# x3)
  {-# INLINE mkX4 #-}
  {-# INLINE unpackX4 #-}
instance Broadcast X4 Word64 where
  broadcast (W64# x) = let !v = broadcastWord64X2# x in MkWord64X4WithVec128 v v
  {-# INLINE broadcast #-}
instance SelectableF X4 Word64 where
  selectF (MkBoolX4 !cond) (MkWord64X4WithVec128 x0 x1) (MkWord64X4WithVec128 y0 y1) = MkWord64X4WithVec128 (selectWord64X2# (cond `unsafeShiftR` 0) x0 y0) (selectWord64X2# (cond `unsafeShiftR` 2) x1 y1)
  {-# INLINE selectF #-}
instance (i0 < 4, i1 < 4, i2 < 4, i3 < 4, ShuffleMany Word64X2# [i0, i1], ShuffleMany Word64X2# [i2, i3]) => UnaryShuffleT [i0, i1, i2, i3] X4 Word64 where
  unaryShuffle (MkWord64X4WithVec128 x0 x1) = let { sources = \case { 0 -> x0; _ -> x1 } } in MkWord64X4WithVec128 (shuffleMany# @_ @_ @[i0, i1] sources) (shuffleMany# @_ @_ @[i2, i3] sources)
  {-# INLINE unaryShuffle #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, ShuffleMany Word64X2# [i0, i1], ShuffleMany Word64X2# [i2, i3]) => BinaryShuffleT [i0, i1, i2, i3] X4 Word64 where
  binaryShuffle (MkWord64X4WithVec128 x0 x1) (MkWord64X4WithVec128 x2 x3) = let { sources = \case { 0 -> x0; 1 -> x1; 2 -> x2; _ -> x3 } } in MkWord64X4WithVec128 (shuffleMany# @_ @_ @[i0, i1] sources) (shuffleMany# @_ @_ @[i2, i3] sources)
  {-# INLINE binaryShuffle #-}
instance EquatableF X4 Word64 where
  eqF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (eqWord64X2# u0 v0)) .|. (fromIntegral (eqWord64X2# u1 v1) `unsafeShiftL` 2)
  {-# INLINE eqF #-}
instance OrderedF X4 Word64 where
  ltF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkBoolX4 $ (fromIntegral (ltWord64X2# u0 v0)) .|. (fromIntegral (ltWord64X2# u1 v1) `unsafeShiftL` 2)
  leF !x !y = complementF (ltF y x)
  gtF !x !y = ltF y x
  geF !x !y = complementF (ltF x y)
  {-# INLINE ltF #-}
...
instance MinMaxF X4 Word64 where
  minF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (minWord64X2# u0 v0) (minWord64X2# u1 v1)
  maxF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (maxWord64X2# u0 v0) (maxWord64X2# u1 v1)
  minimumNumberF = minF
  maximumNumberF = maxF
  {-# INLINE minF #-}
  {-# INLINE maxF #-}
...
instance NumF X4 Word64 where
  plusF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (plusWord64X2# u0 v0) (plusWord64X2# u1 v1)
  minusF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (minusWord64X2# u0 v0) (minusWord64X2# u1 v1)
  timesF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (timesWord64X2# u0 v0) (timesWord64X2# u1 v1)
...
instance BooleanF X4 Word64 where
  andF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (andWord64X2# u0 v0) (andWord64X2# u1 v1)
  orF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (orWord64X2# u0 v0) (orWord64X2# u1 v1)
  xorF (MkWord64X4WithVec128 u0 u1) (MkWord64X4WithVec128 v0 v1) = MkWord64X4WithVec128 (xorWord64X2# u0 v0) (xorWord64X2# u1 v1)
  complementF (MkWord64X4WithVec128 u0 u1) = MkWord64X4WithVec128 (complementWord64X2# u0) (complementWord64X2# u1)
  {-# INLINE andF #-}
  {-# INLINE orF #-}
  {-# INLINE xorF #-}
  {-# INLINE complementF #-}
instance BitShiftF X4 Word64 where
  shiftLF (MkWord64X4WithVec128 u0 u1) (I# i) = MkWord64X4WithVec128 (shiftLWord64X2# u0 i) (shiftLWord64X2# u1 i)
  shiftRF (MkWord64X4WithVec128 u0 u1) (I# i) = MkWord64X4WithVec128 (shiftRWord64X2# u0 i) (shiftRWord64X2# u1 i)
  {-# INLINE shiftLF #-}
  {-# INLINE shiftRF #-}
...
instance MultiPrim X4 Word64 where
  ...
  readByteArraySIMD# mba i s0 = case readWord64ArrayAsWord64X2# mba i s0 of (# s1, v0 #) -> case readWord64ArrayAsWord64X2# mba (i +# 2#) s1 of (# s2, v1 #) -> (# s2, MkWord64X4WithVec128 v0 v1 #)
  writeByteArraySIMD# mba i (MkWord64X4WithVec128 v0 v1) s0 = case writeWord64ArrayAsWord64X2# mba i v0 s0 of s1 -> writeWord64ArrayAsWord64X2# mba (i +# 2#) v1 s1
  {-# INLINE indexByteArraySIMD# #-}
  {-# INLINE readByteArraySIMD# #-}
  {-# INLINE writeByteArraySIMD# #-}
instance MultiStorable X4 Word64 where
  peekElemOffSIMD (Ptr addr) (I# i) = IO (\s0 -> case readWord64OffAddrAsWord64X2# addr i s0 of (# s1, v0 #) -> case readWord64OffAddrAsWord64X2# addr (i +# 2#) s1 of (# s2, v1 #) -> (# s2, MkWord64X4WithVec128 v0 v1 #))
  pokeElemOffSIMD (Ptr addr) (I# i) (MkWord64X4WithVec128 v0 v1) = IO (\s0 -> case writeWord64OffAddrAsWord64X2# addr i v0 s0 of s1 -> case writeWord64OffAddrAsWord64X2# addr (i +# 2#) v1 s1 of s2 -> (# s2, () #))
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
#else
-- The NCG of GHC 9.12 does not support integer vectors
instance ImplementationDescription X4 where
  implementationDescription _ = "X4;maxBits(Float,Double)=128,maxBits(other)=0"
