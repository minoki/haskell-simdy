...
__m128i hs_simdy_shiftL_int8x16(__m128i x, HsInt y)
{
...
__m128i hs_simdy_shiftL_int16x8(__m128i x, HsInt y)
{
    return _mm_sll_epi16(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftL_int32x4(__m128i x, HsInt y)
{
    return _mm_sll_epi32(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftL_int64x2(__m128i x, HsInt y)
{
    return _mm_sll_epi64(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftL_word8x16(__m128i x, HsInt y)
{
    return hs_simdy_shiftL_int8x16(x, y);
}

__m128i hs_simdy_shiftL_word16x8(__m128i x, HsInt y)
{
    return _mm_sll_epi16(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftL_word32x4(__m128i x, HsInt y)
{
    return _mm_sll_epi32(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftL_word64x2(__m128i x, HsInt y)
{
    return _mm_sll_epi64(x, _mm_set_epi64x(0, y));
}
...
__m256i hs_simdy_shiftL_int8x32(__m256i x, HsInt y)
{
...
__m256i hs_simdy_shiftL_int16x16(__m256i x, HsInt y)
{
    return _mm256_sll_epi16(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftL_int32x8(__m256i x, HsInt y)
{
    return _mm256_sll_epi32(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftL_int64x4(__m256i x, HsInt y)
{
    return _mm256_sll_epi64(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftL_word8x32(__m256i x, HsInt y)
{
    return hs_simdy_shiftL_int8x32(x, y);
}

__m256i hs_simdy_shiftL_word16x16(__m256i x, HsInt y)
{
    return _mm256_sll_epi16(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftL_word32x8(__m256i x, HsInt y)
{
    return _mm256_sll_epi32(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftL_word64x4(__m256i x, HsInt y)
{
    return _mm256_sll_epi64(x, _mm_set_epi64x(0, y));
}
...
__m512i hs_simdy_shiftL_int8x64(__m512i x, HsInt y)
{
...
__m512i hs_simdy_shiftL_int16x32(__m512i x, HsInt y)
{
    return _mm512_sll_epi16(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftL_int32x16(__m512i x, HsInt y)
{
    return _mm512_sll_epi32(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftL_int64x8(__m512i x, HsInt y)
{
    return _mm512_sll_epi64(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftL_word8x64(__m512i x, HsInt y)
{
    return hs_simdy_shiftL_int8x64(x, y);
}

__m512i hs_simdy_shiftL_word16x32(__m512i x, HsInt y)
{
    return _mm512_sll_epi16(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftL_word32x16(__m512i x, HsInt y)
{
    return _mm512_sll_epi32(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftL_word64x8(__m512i x, HsInt y)
{
    return _mm512_sll_epi64(x, _mm_set_epi64x(0, y));
}
...
__m128i hs_simdy_shiftR_int8x16(__m128i x, HsInt y)
{
    __m128i zero = _mm_setzero_si128();
...
__m128i hs_simdy_shiftR_int16x8(__m128i x, HsInt y)
{
    return _mm_sra_epi16(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftR_int32x4(__m128i x, HsInt y)
{
    return _mm_sra_epi32(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftR_int64x2(__m128i x, HsInt y)
{
...
__m128i hs_simdy_shiftR_word8x16(__m128i x, HsInt y)
{
    __m128i zero = _mm_setzero_si128();
    __m128i x_lo = _mm_unpacklo_epi8(x, zero);
    __m128i x_hi = _mm_unpackhi_epi8(x, zero);
...
__m128i hs_simdy_shiftR_word16x8(__m128i x, HsInt y)
{
    return _mm_srl_epi16(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftR_word32x4(__m128i x, HsInt y)
{
    return _mm_srl_epi32(x, _mm_set_epi64x(0, y));
}

__m128i hs_simdy_shiftR_word64x2(__m128i x, HsInt y)
{
...
__m256i hs_simdy_shiftR_int8x32(__m256i x, HsInt y)
{
    __m256i zero = _mm256_setzero_si256();
...
__m256i hs_simdy_shiftR_int16x16(__m256i x, HsInt y)
{
    return _mm256_sra_epi16(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftR_int32x8(__m256i x, HsInt y)
{
    return _mm256_sra_epi32(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftR_int64x4(__m256i x, HsInt y)
{
#if defined(__AVX512F__) && defined(__AVX512VL__)
...
__m256i hs_simdy_shiftR_word8x32(__m256i x, HsInt y)
{
    __m256i zero = _mm256_setzero_si256();
    __m256i x_lo = _mm256_unpacklo_epi8(x, zero);
    __m256i x_hi = _mm256_unpackhi_epi8(x, zero);
...
__m256i hs_simdy_shiftR_word16x16(__m256i x, HsInt y)
{
    return _mm256_srl_epi16(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftR_word32x8(__m256i x, HsInt y)
{
    return _mm256_srl_epi32(x, _mm_set_epi64x(0, y));
}

__m256i hs_simdy_shiftR_word64x4(__m256i x, HsInt y)
{
...
__m512i hs_simdy_shiftR_int8x64(__m512i x, HsInt y)
{
    __m512i zero = _mm512_setzero_si512();
...
__m512i hs_simdy_shiftR_int16x32(__m512i x, HsInt y)
{
    return _mm512_sra_epi16(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftR_int32x16(__m512i x, HsInt y)
{
    return _mm512_sra_epi32(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftR_int64x8(__m512i x, HsInt y)
{
    return _mm512_sra_epi64(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftR_word8x64(__m512i x, HsInt y)
{
    __m512i zero = _mm512_setzero_si512();
    __m512i x_lo = _mm512_unpacklo_epi8(x, zero);
    __m512i x_hi = _mm512_unpackhi_epi8(x, zero);
...
__m512i hs_simdy_shiftR_word16x32(__m512i x, HsInt y)
{
    return _mm512_srl_epi16(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftR_word32x16(__m512i x, HsInt y)
{
    return _mm512_srl_epi32(x, _mm_set_epi64x(0, y));
}

__m512i hs_simdy_shiftR_word64x8(__m512i x, HsInt y)
{
...
int8x16_t hs_simdy_complement_int8x16(int8x16_t x)
{
    return vmvnq_s8(x);
}

int16x8_t hs_simdy_complement_int16x8(int16x8_t x)
{
    return vmvnq_s16(x);
}

int32x4_t hs_simdy_complement_int32x4(int32x4_t x)
{
    return vmvnq_s32(x);
}

int64x2_t hs_simdy_complement_int64x2(int64x2_t x)
{
    return vreinterpretq_s64_s32(vmvnq_s32(vreinterpretq_s32_s64(x)));
}

uint8x16_t hs_simdy_complement_word8x16(uint8x16_t x)
{
    return vmvnq_u8(x);
}

uint16x8_t hs_simdy_complement_word16x8(uint16x8_t x)
{
    return vmvnq_u16(x);
}

uint32x4_t hs_simdy_complement_word32x4(uint32x4_t x)
{
    return vmvnq_u32(x);
}

uint64x2_t hs_simdy_complement_word64x2(uint64x2_t x)
{
...
int8x16_t hs_simdy_shiftL_int8x16(int8x16_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s8(x, vdupq_n_s8(y));
}

int16x8_t hs_simdy_shiftL_int16x8(int16x8_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s16(x, vdupq_n_s16(y));
}

int32x4_t hs_simdy_shiftL_int32x4(int32x4_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s32(x, vdupq_n_s32(y));
}

int64x2_t hs_simdy_shiftL_int64x2(int64x2_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s64(x, vdupq_n_s64(y));
}

uint8x16_t hs_simdy_shiftL_word8x16(uint8x16_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u8(x, vdupq_n_s8(y));
}

uint16x8_t hs_simdy_shiftL_word16x8(uint16x8_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u16(x, vdupq_n_s16(y));
}

uint32x4_t hs_simdy_shiftL_word32x4(uint32x4_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u32(x, vdupq_n_s32(y));
}

uint64x2_t hs_simdy_shiftL_word64x2(uint64x2_t x, HsInt y)
{
    if (y >= 128) y = 127;
...
int8x16_t hs_simdy_shiftR_int8x16(int8x16_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s8(x, vdupq_n_s8(-y));
}

int16x8_t hs_simdy_shiftR_int16x8(int16x8_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s16(x, vdupq_n_s16(-y));
}

int32x4_t hs_simdy_shiftR_int32x4(int32x4_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s32(x, vdupq_n_s32(-y));
}

int64x2_t hs_simdy_shiftR_int64x2(int64x2_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_s64(x, vdupq_n_s64(-y));
}

uint8x16_t hs_simdy_shiftR_word8x16(uint8x16_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u8(x, vdupq_n_s8(-y));
}

uint16x8_t hs_simdy_shiftR_word16x8(uint16x8_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u16(x, vdupq_n_s16(-y));
}

uint32x4_t hs_simdy_shiftR_word32x4(uint32x4_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u32(x, vdupq_n_s32(-y));
}

uint64x2_t hs_simdy_shiftR_word64x2(uint64x2_t x, HsInt y)
{
    if (y >= 128) y = 127;
    return vshlq_u64(x, vdupq_n_s64(-y));
}
