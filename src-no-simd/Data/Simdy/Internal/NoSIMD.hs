...
#endif
module Data.Simdy.Internal.NoSIMD
  ( module M
  , SIMD (horizontalFold)
  , SIMDElement
  , broadcast
...
class ( PackX2 X2 a
      ...
      , SelectableF X32 a
      , SelectableF X64 a
      , forall indices. UnaryShuffle indices X2 => UnaryShuffleT indices X2 a
      , forall indices. UnaryShuffle indices X4 => UnaryShuffleT indices X4 a
      , forall indices. UnaryShuffle indices X8 => UnaryShuffleT indices X8 a
      , forall indices. UnaryShuffle indices X16 => UnaryShuffleT indices X16 a
      , forall indices. UnaryShuffle indices X32 => UnaryShuffleT indices X32 a
      , forall indices. UnaryShuffle indices X64 => UnaryShuffleT indices X64 a
      , forall indices. BinaryShuffle indices X2 => BinaryShuffleT indices X2 a
      , forall indices. BinaryShuffle indices X4 => BinaryShuffleT indices X4 a
      , forall indices. BinaryShuffle indices X8 => BinaryShuffleT indices X8 a
      , forall indices. BinaryShuffle indices X16 => BinaryShuffleT indices X16 a
      , forall indices. BinaryShuffle indices X32 => BinaryShuffleT indices X32 a
      , forall indices. BinaryShuffle indices X64 => BinaryShuffleT indices X64 a
      ) => SIMDElement a
...
type UnaryShuffle indices x
  = ( UnaryShuffleFor x indices
    , UnaryShuffleT indices x Int8
    , UnaryShuffleT indices x Int16
    , UnaryShuffleT indices x Int32
    , UnaryShuffleT indices x Int64
    , UnaryShuffleT indices x Word8
    , UnaryShuffleT indices x Word16
    , UnaryShuffleT indices x Word32
    , UnaryShuffleT indices x Word64
    , UnaryShuffleT indices x Float
    , UnaryShuffleT indices x Double
    , UnaryShuffleT indices x ()
    )
...
type BinaryShuffle indices x
  = ( BinaryShuffleFor x indices
    , BinaryShuffleT indices x Int8
    , BinaryShuffleT indices x Int16
    , BinaryShuffleT indices x Int32
    , BinaryShuffleT indices x Int64
    , BinaryShuffleT indices x Word8
    , BinaryShuffleT indices x Word16
    , BinaryShuffleT indices x Word32
    , BinaryShuffleT indices x Word64
    , BinaryShuffleT indices x Float
    , BinaryShuffleT indices x Double
    , BinaryShuffleT indices x ()
    )

#if MIN_VERSION_GLASGOW_HASKELL(9, 10, 0, 0)

unaryShuffleX2 :: X2 a -> forall t -> UnaryShuffleT (Tuple2ToList t) X2 a => X2 a
unaryShuffleX2 v t = unaryShuffle @(Tuple2ToList t) v
{-# INLINE unaryShuffleX2 #-}

unaryShuffleX4 :: X4 a -> forall t -> UnaryShuffleT (Tuple4ToList t) X4 a => X4 a
unaryShuffleX4 v t = unaryShuffle @(Tuple4ToList t) v
{-# INLINE unaryShuffleX4 #-}

unaryShuffleX8 :: X8 a -> forall t -> UnaryShuffleT (Tuple8ToList t) X8 a => X8 a
unaryShuffleX8 v t = unaryShuffle @(Tuple8ToList t) v
{-# INLINE unaryShuffleX8 #-}

unaryShuffleX16 :: X16 a -> forall t -> UnaryShuffleT (Tuple16ToList t) X16 a => X16 a
unaryShuffleX16 v t = unaryShuffle @(Tuple16ToList t) v
{-# INLINE unaryShuffleX16 #-}

unaryShuffleX32 :: X32 a -> forall t -> UnaryShuffleT (Tuple32ToList t) X32 a => X32 a
unaryShuffleX32 v t = unaryShuffle @(Tuple32ToList t) v
{-# INLINE unaryShuffleX32 #-}

unaryShuffleX64 :: X64 a -> forall t -> UnaryShuffleT (Tuple64ToList t) X64 a => X64 a
unaryShuffleX64 v t = unaryShuffle @(Tuple64ToList t) v
{-# INLINE unaryShuffleX64 #-}

binaryShuffleX2 :: X2 a -> X2 a -> forall t -> BinaryShuffleT (Tuple2ToList t) X2 a => X2 a
binaryShuffleX2 u v t = binaryShuffle @(Tuple2ToList t) u v
{-# INLINE binaryShuffleX2 #-}

binaryShuffleX4 :: X4 a -> X4 a -> forall t -> BinaryShuffleT (Tuple4ToList t) X4 a => X4 a
binaryShuffleX4 u v t = binaryShuffle @(Tuple4ToList t) u v
{-# INLINE binaryShuffleX4 #-}

binaryShuffleX8 :: X8 a -> X8 a -> forall t -> BinaryShuffleT (Tuple8ToList t) X8 a => X8 a
binaryShuffleX8 u v t = binaryShuffle @(Tuple8ToList t) u v
{-# INLINE binaryShuffleX8 #-}

binaryShuffleX16 :: X16 a -> X16 a -> forall t -> BinaryShuffleT (Tuple16ToList t) X16 a => X16 a
binaryShuffleX16 u v t = binaryShuffle @(Tuple16ToList t) u v
{-# INLINE binaryShuffleX16 #-}

binaryShuffleX32 :: X32 a -> X32 a -> forall t -> BinaryShuffleT (Tuple32ToList t) X32 a => X32 a
binaryShuffleX32 u v t = binaryShuffle @(Tuple32ToList t) u v
{-# INLINE binaryShuffleX32 #-}

binaryShuffleX64 :: X64 a -> X64 a -> forall t -> BinaryShuffleT (Tuple64ToList t) X64 a => X64 a
...
binaryShuffleWithX2 :: forall i0 i1 a. BinaryShuffleT '[i0, i1] X2 a => ((Proxy 0, Proxy 1) -> (Proxy 2, Proxy 3) -> (Proxy i0, Proxy i1)) -> X2 a -> X2 a -> X2 a
binaryShuffleWithX2 _ = binaryShuffle @'[i0, i1]
{-# INLINE binaryShuffleWithX2 #-}

binaryShuffleWithX4 :: forall i0 i1 i2 i3 a. BinaryShuffleT '[i0, i1, i2, i3] X4 a => ((Proxy 0, Proxy 1, Proxy 2, Proxy 3) -> (Proxy 4, Proxy 5, Proxy 6, Proxy 7) -> (Proxy i0, Proxy i1, Proxy i2, Proxy i3)) -> X4 a -> X4 a -> X4 a
binaryShuffleWithX4 _ = binaryShuffle @'[i0, i1, i2, i3]
{-# INLINE binaryShuffleWithX4 #-}

binaryShuffleWithX8 :: forall i0 i1 i2 i3 i4 i5 i6 i7 a. BinaryShuffleT '[i0, i1, i2, i3, i4, i5, i6, i7] X8 a => ((Proxy 0, Proxy 1, Proxy 2, Proxy 3, Proxy 4, Proxy 5, Proxy 6, Proxy 7) -> (Proxy 8, Proxy 9, Proxy 10, Proxy 11, Proxy 12, Proxy 13, Proxy 14, Proxy 15) -> (Proxy i0, Proxy i1, Proxy i2, Proxy i3, Proxy i4, Proxy i5, Proxy i6, Proxy i7)) -> X8 a -> X8 a -> X8 a
binaryShuffleWithX8 _ = binaryShuffle @'[i0, i1, i2, i3, i4, i5, i6, i7]
{-# INLINE binaryShuffleWithX8 #-}

binaryShuffleWithX16 :: forall i0 i1 i2 i3 i4 i5 i6 i7 i8 i9 i10 i11 i12 i13 i14 i15 a. BinaryShuffleT '[i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15] X16 a => ((Proxy 0, Proxy 1, Proxy 2, Proxy 3, Proxy 4, Proxy 5, Proxy 6, Proxy 7, Proxy 8, Proxy 9, Proxy 10, Proxy 11, Proxy 12, Proxy 13, Proxy 14, Proxy 15) -> (Proxy 16, Proxy 17, Proxy 18, Proxy 19, Proxy 20, Proxy 21, Proxy 22, Proxy 23, Proxy 24, Proxy 25, Proxy 26, Proxy 27, Proxy 28, Proxy 29, Proxy 30, Proxy 31) -> (Proxy i0, Proxy i1, Proxy i2, Proxy i3, Proxy i4, Proxy i5, Proxy i6, Proxy i7, Proxy i8, Proxy i9, Proxy i10, Proxy i11, Proxy i12, Proxy i13, Proxy i14, Proxy i15)) -> X16 a -> X16 a -> X16 a
binaryShuffleWithX16 _ = binaryShuffle @'[i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15]
{-# INLINE binaryShuffleWithX16 #-}

binaryShuffleWithX32 :: forall i0 i1 i2 i3 i4 i5 i6 i7 i8 i9 i10 i11 i12 i13 i14 i15 i16 i17 i18 i19 i20 i21 i22 i23 i24 i25 i26 i27 i28 i29 i30 i31 a. BinaryShuffleT '[i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23, i24, i25, i26, i27, i28, i29, i30, i31] X32 a => ((Proxy 0, Proxy 1, Proxy 2, Proxy 3, Proxy 4, Proxy 5, Proxy 6, Proxy 7, Proxy 8, Proxy 9, Proxy 10, Proxy 11, Proxy 12, Proxy 13, Proxy 14, Proxy 15, Proxy 16, Proxy 17, Proxy 18, Proxy 19, Proxy 20, Proxy 21, Proxy 22, Proxy 23, Proxy 24, Proxy 25, Proxy 26, Proxy 27, Proxy 28, Proxy 29, Proxy 30, Proxy 31) -> (Proxy 32, Proxy 33, Proxy 34, Proxy 35, Proxy 36, Proxy 37, Proxy 38, Proxy 39, Proxy 40, Proxy 41, Proxy 42, Proxy 43, Proxy 44, Proxy 45, Proxy 46, Proxy 47, Proxy 48, Proxy 49, Proxy 50, Proxy 51, Proxy 52, Proxy 53, Proxy 54, Proxy 55, Proxy 56, Proxy 57, Proxy 58, Proxy 59, Proxy 60, Proxy 61, Proxy 62, Proxy 63) -> (Proxy i0, Proxy i1, Proxy i2, Proxy i3, Proxy i4, Proxy i5, Proxy i6, Proxy i7, Proxy i8, Proxy i9, Proxy i10, Proxy i11, Proxy i12, Proxy i13, Proxy i14, Proxy i15, Proxy i16, Proxy i17, Proxy i18, Proxy i19, Proxy i20, Proxy i21, Proxy i22, Proxy i23, Proxy i24, Proxy i25, Proxy i26, Proxy i27, Proxy i28, Proxy i29, Proxy i30, Proxy i31)) -> X32 a -> X32 a -> X32 a
