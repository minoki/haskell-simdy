...
absInt16X16# u = case unpackInt16X16# u of (# u0, u1, u2, u3, u4, u5, u6, u7, u8, u9, u10, u11, u12, u13, u14, u15 #) -> packInt16X16# (# case ltInt16# u0 (intToInt16# 0#) of { 0# -> u0; _ -> negateInt16# u0 }, case ltInt16# u1 (intToInt16# 0#) of { 0# -> u1; _ -> negateInt16# u1 }, case ltInt16# u2 (intToInt16# 0#) of { 0# -> u2; _ -> negateInt16# u2 }, case ltInt16# u3 (intToInt16# 0#) of { 0# -> u3; _ -> negateInt16# u3 }, case ltInt16# u4 (intToInt16# 0#) of { 0# -> u4; _ -> negateInt16# u4 }, case ltInt16# u5 (intToInt16# 0#) of { 0# -> u5; _ -> negateInt16# u5 }, case ltInt16# u6 (intToInt16# 0#) of { 0# -> u6; _ -> negateInt16# u6 }, case ltInt16# u7 (intToInt16# 0#) of { 0# -> u7; _ -> negateInt16# u7 }, case ltInt16# u8 (intToInt16# 0#) of { 0# -> u8; _ -> negateInt16# u8 }, case ltInt16# u9 (intToInt16# 0#) of { 0# -> u9; _ -> negateInt16# u9 }, case ltInt16# u10 (intToInt16# 0#) of { 0# -> u10; _ -> negateInt16# u10 }, case ltInt16# u11 (intToInt16# 0#) of { 0# -> u11; _ -> negateInt16# u11 }, case ltInt16# u12 (intToInt16# 0#) of { 0# -> u12; _ -> negateInt16# u12 }, case ltInt16# u13 (intToInt16# 0#) of { 0# -> u13; _ -> negateInt16# u13 }, case ltInt16# u14 (intToInt16# 0#) of { 0# -> u14; _ -> negateInt16# u14 }, case ltInt16# u15 (intToInt16# 0#) of { 0# -> u15; _ -> negateInt16# u15 } #)
{-# INLINE [0] absInt16X16# #-}

absInt32X8# :: Int32X8# -> Int32X8#
absInt32X8# u = case unpackInt32X8# u of (# u0, u1, u2, u3, u4, u5, u6, u7 #) -> packInt32X8# (# case ltInt32# u0 (intToInt32# 0#) of { 0# -> u0; _ -> negateInt32# u0 }, case ltInt32# u1 (intToInt32# 0#) of { 0# -> u1; _ -> negateInt32# u1 }, case ltInt32# u2 (intToInt32# 0#) of { 0# -> u2; _ -> negateInt32# u2 }, case ltInt32# u3 (intToInt32# 0#) of { 0# -> u3; _ -> negateInt32# u3 }, case ltInt32# u4 (intToInt32# 0#) of { 0# -> u4; _ -> negateInt32# u4 }, case ltInt32# u5 (intToInt32# 0#) of { 0# -> u5; _ -> negateInt32# u5 }, case ltInt32# u6 (intToInt32# 0#) of { 0# -> u6; _ -> negateInt32# u6 }, case ltInt32# u7 (intToInt32# 0#) of { 0# -> u7; _ -> negateInt32# u7 } #)
{-# INLINE [0] absInt32X8# #-}

absInt64X4# :: Int64X4# -> Int64X4#
absInt64X4# u = case unpackInt64X4# u of (# u0, u1, u2, u3 #) -> packInt64X4# (# case ltInt64# u0 (intToInt64# 0#) of { 0# -> u0; _ -> negateInt64# u0 }, case ltInt64# u1 (intToInt64# 0#) of { 0# -> u1; _ -> negateInt64# u1 }, case ltInt64# u2 (intToInt64# 0#) of { 0# -> u2; _ -> negateInt64# u2 }, case ltInt64# u3 (intToInt64# 0#) of { 0# -> u3; _ -> negateInt64# u3 } #)
{-# INLINE [0] absInt64X4# #-}
