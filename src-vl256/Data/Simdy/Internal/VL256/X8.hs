...
instance SelectableF X8 Double where
  ...
  {-# INLINE selectF #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, i4 < 8, i5 < 8, i6 < 8, i7 < 8, ShuffleMany DoubleX4# [i0, i1, i2, i3], ShuffleMany DoubleX4# [i4, i5, i6, i7]) => UnaryShuffleT [i0, i1, i2, i3, i4, i5, i6, i7] X8 Double where
  ...
  {-# INLINE unaryShuffle #-}
instance (i0 < 16, i1 < 16, i2 < 16, i3 < 16, i4 < 16, i5 < 16, i6 < 16, i7 < 16, ShuffleMany DoubleX4# [i0, i1, i2, i3], ShuffleMany DoubleX4# [i4, i5, i6, i7]) => BinaryShuffleT [i0, i1, i2, i3, i4, i5, i6, i7] X8 Double where
...
instance SelectableF X8 Int64 where
  ...
  {-# INLINE selectF #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, i4 < 8, i5 < 8, i6 < 8, i7 < 8, ShuffleMany Int64X4# [i0, i1, i2, i3], ShuffleMany Int64X4# [i4, i5, i6, i7]) => UnaryShuffleT [i0, i1, i2, i3, i4, i5, i6, i7] X8 Int64 where
  ...
  {-# INLINE unaryShuffle #-}
instance (i0 < 16, i1 < 16, i2 < 16, i3 < 16, i4 < 16, i5 < 16, i6 < 16, i7 < 16, ShuffleMany Int64X4# [i0, i1, i2, i3], ShuffleMany Int64X4# [i4, i5, i6, i7]) => BinaryShuffleT [i0, i1, i2, i3, i4, i5, i6, i7] X8 Int64 where
...
instance SelectableF X8 Word64 where
  ...
  {-# INLINE selectF #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, i4 < 8, i5 < 8, i6 < 8, i7 < 8, ShuffleMany Word64X4# [i0, i1, i2, i3], ShuffleMany Word64X4# [i4, i5, i6, i7]) => UnaryShuffleT [i0, i1, i2, i3, i4, i5, i6, i7] X8 Word64 where
  ...
  {-# INLINE unaryShuffle #-}
instance (i0 < 16, i1 < 16, i2 < 16, i3 < 16, i4 < 16, i5 < 16, i6 < 16, i7 < 16, ShuffleMany Word64X4# [i0, i1, i2, i3], ShuffleMany Word64X4# [i4, i5, i6, i7]) => BinaryShuffleT [i0, i1, i2, i3, i4, i5, i6, i7] X8 Word64 where
