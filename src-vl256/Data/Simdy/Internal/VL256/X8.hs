...
module Data.Simdy.Internal.VL256.X8 where
import           Data.Bits
...
#else
  enumFromZero = mkX8 0 1 2 3 4 5 6 7
#endif
  -- {-# INLINE enumFromZero #-}
...
data instance X8 Double = MkDoubleX8WithVec256 DoubleX4# DoubleX4#
instance PackX8 X8 Double where
  mkX8 (D# x0) (D# x1) (D# x2) (D# x3) (D# x4) (D# x5) (D# x6) (D# x7) = MkDoubleX8WithVec256 (packDoubleX4# (# x0, x1, x2, x3 #)) (packDoubleX4# (# x4, x5, x6, x7 #))
  unpackX8 (MkDoubleX8WithVec256 v0 v1) = case unpackDoubleX4# v0 of (# x0, x1, x2, x3 #) -> case unpackDoubleX4# v1 of (# x4, x5, x6, x7 #) -> (D# x0, D# x1, D# x2, D# x3, D# x4, D# x5, D# x6, D# x7)
  {-# INLINE mkX8 #-}
  {-# INLINE unpackX8 #-}
instance Broadcast X8 Double where
  broadcast (D# x) = let !v = broadcastDoubleX4# x in MkDoubleX8WithVec256 v v
  {-# INLINE broadcast #-}
instance SelectableF X8 Double where
  selectF (MkBoolX8 !cond) (MkDoubleX8WithVec256 x0 x1) (MkDoubleX8WithVec256 y0 y1) = MkDoubleX8WithVec256 (selectDoubleX4# (cond `unsafeShiftR` 0) x0 y0) (selectDoubleX4# (cond `unsafeShiftR` 4) x1 y1)
  {-# INLINE selectF #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, i4 < 8, i5 < 8, i6 < 8, i7 < 8, ShuffleMany DoubleX4# [i0, i1, i2, i3], ShuffleMany DoubleX4# [i4, i5, i6, i7]) => UnaryShuffle [i0, i1, i2, i3, i4, i5, i6, i7] X8 Double where
  unaryShuffle (MkDoubleX8WithVec256 x0 x1) = let { sources = \case { 0 -> x0; _ -> x1 } } in MkDoubleX8WithVec256 (shuffleMany# @_ @_ @[i0, i1, i2, i3] sources) (shuffleMany# @_ @_ @[i4, i5, i6, i7] sources)
  {-# INLINE unaryShuffle #-}
instance (i0 < 16, i1 < 16, i2 < 16, i3 < 16, i4 < 16, i5 < 16, i6 < 16, i7 < 16, ShuffleMany DoubleX4# [i0, i1, i2, i3], ShuffleMany DoubleX4# [i4, i5, i6, i7]) => BinaryShuffle [i0, i1, i2, i3, i4, i5, i6, i7] X8 Double where
  binaryShuffle (MkDoubleX8WithVec256 x0 x1) (MkDoubleX8WithVec256 x2 x3) = let { sources = \case { 0 -> x0; 1 -> x1; 2 -> x2; _ -> x3 } } in MkDoubleX8WithVec256 (shuffleMany# @_ @_ @[i0, i1, i2, i3] sources) (shuffleMany# @_ @_ @[i4, i5, i6, i7] sources)
  {-# INLINE binaryShuffle #-}
instance EquatableF X8 Double where
  eqF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (eqDoubleX4# u0 v0)) .|. (fromIntegral (eqDoubleX4# u1 v1) `unsafeShiftL` 4)
  {-# INLINE eqF #-}
instance OrderedF X8 Double where
  ltF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (ltDoubleX4# u0 v0)) .|. (fromIntegral (ltDoubleX4# u1 v1) `unsafeShiftL` 4)
  leF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (leDoubleX4# u0 v0)) .|. (fromIntegral (leDoubleX4# u1 v1) `unsafeShiftL` 4)
  gtF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (gtDoubleX4# u0 v0)) .|. (fromIntegral (gtDoubleX4# u1 v1) `unsafeShiftL` 4)
  geF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (geDoubleX4# u0 v0)) .|. (fromIntegral (geDoubleX4# u1 v1) `unsafeShiftL` 4)
  {-# INLINE ltF #-}
  {-# INLINE leF #-}
  {-# INLINE gtF #-}
  {-# INLINE geF #-}
instance MinMaxF X8 Double where
  minF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (minimumDoubleX4# u0 v0) (minimumDoubleX4# u1 v1)
  maxF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (maximumDoubleX4# u0 v0) (maximumDoubleX4# u1 v1)
  minimumNumberF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (minimumNumberDoubleX4# u0 v0) (minimumNumberDoubleX4# u1 v1)
  maximumNumberF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (maximumNumberDoubleX4# u0 v0) (maximumNumberDoubleX4# u1 v1)
  {-# INLINE minF #-}
  {-# INLINE maxF #-}
  {-# INLINE minimumNumberF #-}
  {-# INLINE maximumNumberF #-}
negateX8Double :: X8 Double -> X8 Double
negateX8Double (MkDoubleX8WithVec256 u0 u1) = MkDoubleX8WithVec256 (negateDoubleX4# u0) (negateDoubleX4# u1)
#if defined(USE_FMA)
...
instance NumF X8 Double where
  plusF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (plusDoubleX4# u0 v0) (plusDoubleX4# u1 v1)
  minusF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (minusDoubleX4# u0 v0) (minusDoubleX4# u1 v1)
  timesF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (timesDoubleX4# u0 v0) (timesDoubleX4# u1 v1)
  negateF = negateX8Double
  absF (MkDoubleX8WithVec256 u0 u1) = MkDoubleX8WithVec256 (absDoubleX4# u0) (absDoubleX4# u1)
  {-# INLINE plusF #-}
  {-# INLINE minusF #-}
  {-# INLINE timesF #-}
  {-# INLINE negateF #-}
...
instance FractionalF X8 Double where
  divideF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) = MkDoubleX8WithVec256 (divideDoubleX4# u0 v0) (divideDoubleX4# u1 v1)
  {-# INLINE divideF #-}
instance FloatingF X8 Double where
  sqrtF (MkDoubleX8WithVec256 u0 u1) = MkDoubleX8WithVec256 (sqrtDoubleX4# u0) (sqrtDoubleX4# u1)
  {-# INLINE sqrtF #-}
instance HasFMA => FusedMultiplyAddF X8 Double where
#if defined(USE_FMA)
  fusedMultiplyAddF (MkDoubleX8WithVec256 u0 u1) (MkDoubleX8WithVec256 v0 v1) (MkDoubleX8WithVec256 w0 w1) = MkDoubleX8WithVec256 (fmaddDoubleX4# u0 v0 w0) (fmaddDoubleX4# u1 v1 w1)
  {-# INLINE fusedMultiplyAddF #-}
#else
  fusedMultiplyAddF _ _ _ = fmaIsDisabled
#endif
...
#if MIN_VERSION_GLASGOW_HASKELL(9, 8, 1, 0)
  enumFromZero = MkDoubleX8WithVec256 (packDoubleX4# (# 0.0##, 1.0##, 2.0##, 3.0## #)) (packDoubleX4# (# 4.0##, 5.0##, 6.0##, 7.0## #))
#else
  enumFromZero = mkX8 0 1 2 3 4 5 6 7
#endif
  -- {-# INLINE enumFromZero #-}
instance MultiPrim X8 Double where
  indexByteArraySIMD# ba i = MkDoubleX8WithVec256 (indexDoubleArrayAsDoubleX4# ba i) (indexDoubleArrayAsDoubleX4# ba (i +# 4#))
  readByteArraySIMD# mba i s0 = case readDoubleArrayAsDoubleX4# mba i s0 of (# s1, v0 #) -> case readDoubleArrayAsDoubleX4# mba (i +# 4#) s1 of (# s2, v1 #) -> (# s2, MkDoubleX8WithVec256 v0 v1 #)
  writeByteArraySIMD# mba i (MkDoubleX8WithVec256 v0 v1) s0 = case writeDoubleArrayAsDoubleX4# mba i v0 s0 of s1 -> writeDoubleArrayAsDoubleX4# mba (i +# 4#) v1 s1
  {-# INLINE indexByteArraySIMD# #-}
  {-# INLINE readByteArraySIMD# #-}
  {-# INLINE writeByteArraySIMD# #-}
instance MultiStorable X8 Double where
  peekElemOffSIMD (Ptr addr) (I# i) = IO (\s0 -> case readDoubleOffAddrAsDoubleX4# addr i s0 of (# s1, v0 #) -> case readDoubleOffAddrAsDoubleX4# addr (i +# 4#) s1 of (# s2, v1 #) -> (# s2, MkDoubleX8WithVec256 v0 v1 #))
  pokeElemOffSIMD (Ptr addr) (I# i) (MkDoubleX8WithVec256 v0 v1) = IO (\s0 -> case writeDoubleOffAddrAsDoubleX4# addr i v0 s0 of s1 -> case writeDoubleOffAddrAsDoubleX4# addr (i +# 4#) v1 s1 of s2 -> (# s2, () #))
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
instance ImplementationDescription X8 where
  implementationDescription _ = "X8;maxBits=256"
data instance X8 Int8 = MkInt8X8 Int8X16#
instance PackX8 X8 Int8 where
  mkX8 (I8# x0) (I8# x1) (I8# x2) (I8# x3) (I8# x4) (I8# x5) (I8# x6) (I8# x7) = MkInt8X8 (packInt8X16# (# x0, x1, x2, x3, x4, x5, x6, x7, intToInt8# 0#, intToInt8# 0#, intToInt8# 0#, intToInt8# 0#, intToInt8# 0#, intToInt8# 0#, intToInt8# 0#, intToInt8# 0# #))
...
instance MultiStorable X8 Int32 where
  ...
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
data instance X8 Int64 = MkInt64X8WithVec256 Int64X4# Int64X4#
instance PackX8 X8 Int64 where
  mkX8 (I64# x0) (I64# x1) (I64# x2) (I64# x3) (I64# x4) (I64# x5) (I64# x6) (I64# x7) = MkInt64X8WithVec256 (packInt64X4# (# x0, x1, x2, x3 #)) (packInt64X4# (# x4, x5, x6, x7 #))
  unpackX8 (MkInt64X8WithVec256 v0 v1) = case unpackInt64X4# v0 of (# x0, x1, x2, x3 #) -> case unpackInt64X4# v1 of (# x4, x5, x6, x7 #) -> (I64# x0, I64# x1, I64# x2, I64# x3, I64# x4, I64# x5, I64# x6, I64# x7)
  {-# INLINE mkX8 #-}
  {-# INLINE unpackX8 #-}
instance Broadcast X8 Int64 where
  broadcast (I64# x) = let !v = broadcastInt64X4# x in MkInt64X8WithVec256 v v
  {-# INLINE broadcast #-}
instance SelectableF X8 Int64 where
  selectF (MkBoolX8 !cond) (MkInt64X8WithVec256 x0 x1) (MkInt64X8WithVec256 y0 y1) = MkInt64X8WithVec256 (selectInt64X4# (cond `unsafeShiftR` 0) x0 y0) (selectInt64X4# (cond `unsafeShiftR` 4) x1 y1)
  {-# INLINE selectF #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, i4 < 8, i5 < 8, i6 < 8, i7 < 8, ShuffleMany Int64X4# [i0, i1, i2, i3], ShuffleMany Int64X4# [i4, i5, i6, i7]) => UnaryShuffle [i0, i1, i2, i3, i4, i5, i6, i7] X8 Int64 where
  unaryShuffle (MkInt64X8WithVec256 x0 x1) = let { sources = \case { 0 -> x0; _ -> x1 } } in MkInt64X8WithVec256 (shuffleMany# @_ @_ @[i0, i1, i2, i3] sources) (shuffleMany# @_ @_ @[i4, i5, i6, i7] sources)
  {-# INLINE unaryShuffle #-}
instance (i0 < 16, i1 < 16, i2 < 16, i3 < 16, i4 < 16, i5 < 16, i6 < 16, i7 < 16, ShuffleMany Int64X4# [i0, i1, i2, i3], ShuffleMany Int64X4# [i4, i5, i6, i7]) => BinaryShuffle [i0, i1, i2, i3, i4, i5, i6, i7] X8 Int64 where
  binaryShuffle (MkInt64X8WithVec256 x0 x1) (MkInt64X8WithVec256 x2 x3) = let { sources = \case { 0 -> x0; 1 -> x1; 2 -> x2; _ -> x3 } } in MkInt64X8WithVec256 (shuffleMany# @_ @_ @[i0, i1, i2, i3] sources) (shuffleMany# @_ @_ @[i4, i5, i6, i7] sources)
  {-# INLINE binaryShuffle #-}
instance EquatableF X8 Int64 where
  eqF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (eqInt64X4# u0 v0)) .|. (fromIntegral (eqInt64X4# u1 v1) `unsafeShiftL` 4)
  {-# INLINE eqF #-}
instance OrderedF X8 Int64 where
  ltF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (ltInt64X4# u0 v0)) .|. (fromIntegral (ltInt64X4# u1 v1) `unsafeShiftL` 4)
  leF !x !y = complementF (ltF y x)
  gtF !x !y = ltF y x
  geF !x !y = complementF (ltF x y)
  {-# INLINE ltF #-}
...
instance MinMaxF X8 Int64 where
  minF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (minInt64X4# u0 v0) (minInt64X4# u1 v1)
  maxF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (maxInt64X4# u0 v0) (maxInt64X4# u1 v1)
  minimumNumberF = minF
  maximumNumberF = maxF
  {-# INLINE minF #-}
  {-# INLINE maxF #-}
...
instance NumF X8 Int64 where
  plusF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (plusInt64X4# u0 v0) (plusInt64X4# u1 v1)
  minusF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (minusInt64X4# u0 v0) (minusInt64X4# u1 v1)
  timesF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (timesInt64X4# u0 v0) (timesInt64X4# u1 v1)
  negateF (MkInt64X8WithVec256 u0 u1) = MkInt64X8WithVec256 (negateInt64X4# u0) (negateInt64X4# u1)
  absF (MkInt64X8WithVec256 u0 u1) = MkInt64X8WithVec256 (absInt64X4# u0) (absInt64X4# u1)
  {-# INLINE plusF #-}
  {-# INLINE minusF #-}
  {-# INLINE timesF #-}
  {-# INLINE negateF #-}
...
instance BooleanF X8 Int64 where
  andF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (andInt64X4# u0 v0) (andInt64X4# u1 v1)
  orF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (orInt64X4# u0 v0) (orInt64X4# u1 v1)
  xorF (MkInt64X8WithVec256 u0 u1) (MkInt64X8WithVec256 v0 v1) = MkInt64X8WithVec256 (xorInt64X4# u0 v0) (xorInt64X4# u1 v1)
  complementF (MkInt64X8WithVec256 u0 u1) = MkInt64X8WithVec256 (complementInt64X4# u0) (complementInt64X4# u1)
  {-# INLINE andF #-}
  {-# INLINE orF #-}
  {-# INLINE xorF #-}
  {-# INLINE complementF #-}
instance BitShiftF X8 Int64 where
  shiftLF (MkInt64X8WithVec256 u0 u1) (I# i) = MkInt64X8WithVec256 (shiftLInt64X4# u0 i) (shiftLInt64X4# u1 i)
  shiftRF (MkInt64X8WithVec256 u0 u1) (I# i) = MkInt64X8WithVec256 (shiftRInt64X4# u0 i) (shiftRInt64X4# u1 i)
  {-# INLINE shiftLF #-}
  {-# INLINE shiftRF #-}
instance EnumFromZero_ X8 Int64 where
#if MIN_VERSION_GLASGOW_HASKELL(9, 8, 1, 0)
  enumFromZero = MkInt64X8WithVec256 (packInt64X4# (# 0#Int64, 1#Int64, 2#Int64, 3#Int64 #)) (packInt64X4# (# 4#Int64, 5#Int64, 6#Int64, 7#Int64 #))
#else
  enumFromZero = mkX8 0 1 2 3 4 5 6 7
#endif
  -- {-# INLINE enumFromZero #-}
instance MultiPrim X8 Int64 where
  indexByteArraySIMD# ba i = MkInt64X8WithVec256 (indexInt64ArrayAsInt64X4# ba i) (indexInt64ArrayAsInt64X4# ba (i +# 4#))
  readByteArraySIMD# mba i s0 = case readInt64ArrayAsInt64X4# mba i s0 of (# s1, v0 #) -> case readInt64ArrayAsInt64X4# mba (i +# 4#) s1 of (# s2, v1 #) -> (# s2, MkInt64X8WithVec256 v0 v1 #)
  writeByteArraySIMD# mba i (MkInt64X8WithVec256 v0 v1) s0 = case writeInt64ArrayAsInt64X4# mba i v0 s0 of s1 -> writeInt64ArrayAsInt64X4# mba (i +# 4#) v1 s1
  {-# INLINE indexByteArraySIMD# #-}
  {-# INLINE readByteArraySIMD# #-}
  {-# INLINE writeByteArraySIMD# #-}
instance MultiStorable X8 Int64 where
  peekElemOffSIMD (Ptr addr) (I# i) = IO (\s0 -> case readInt64OffAddrAsInt64X4# addr i s0 of (# s1, v0 #) -> case readInt64OffAddrAsInt64X4# addr (i +# 4#) s1 of (# s2, v1 #) -> (# s2, MkInt64X8WithVec256 v0 v1 #))
  pokeElemOffSIMD (Ptr addr) (I# i) (MkInt64X8WithVec256 v0 v1) = IO (\s0 -> case writeInt64OffAddrAsInt64X4# addr i v0 s0 of s1 -> case writeInt64OffAddrAsInt64X4# addr (i +# 4#) v1 s1 of s2 -> (# s2, () #))
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
data instance X8 Word8 = MkWord8X8 Word8X16#
instance PackX8 X8 Word8 where
  mkX8 (W8# x0) (W8# x1) (W8# x2) (W8# x3) (W8# x4) (W8# x5) (W8# x6) (W8# x7) = MkWord8X8 (packWord8X16# (# x0, x1, x2, x3, x4, x5, x6, x7, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0## #))
...
instance MultiPrim X8 Word8 where
  indexByteArraySIMD# ba i = MkWord8X8 (packWord8X16# (# GHC.Exts.indexWord8Array# ba i, GHC.Exts.indexWord8Array# ba (i +# 1#), GHC.Exts.indexWord8Array# ba (i +# 2#), GHC.Exts.indexWord8Array# ba (i +# 3#), GHC.Exts.indexWord8Array# ba (i +# 4#), GHC.Exts.indexWord8Array# ba (i +# 5#), GHC.Exts.indexWord8Array# ba (i +# 6#), GHC.Exts.indexWord8Array# ba (i +# 7#), wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0## #))
  readByteArraySIMD# mba i s0 = case GHC.Exts.readWord8Array# mba i s0 of (# s1, x0 #) -> case GHC.Exts.readWord8Array# mba (i +# 1#) s1 of (# s2, x1 #) -> case GHC.Exts.readWord8Array# mba (i +# 2#) s2 of (# s3, x2 #) -> case GHC.Exts.readWord8Array# mba (i +# 3#) s3 of (# s4, x3 #) -> case GHC.Exts.readWord8Array# mba (i +# 4#) s4 of (# s5, x4 #) -> case GHC.Exts.readWord8Array# mba (i +# 5#) s5 of (# s6, x5 #) -> case GHC.Exts.readWord8Array# mba (i +# 6#) s6 of (# s7, x6 #) -> case GHC.Exts.readWord8Array# mba (i +# 7#) s7 of (# s8, x7 #) -> (# s8, MkWord8X8 (packWord8X16# (# x0, x1, x2, x3, x4, x5, x6, x7, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0##, wordToWord8# 0## #)) #)
...
instance MultiStorable X8 Word32 where
  ...
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
data instance X8 Word64 = MkWord64X8WithVec256 Word64X4# Word64X4#
instance PackX8 X8 Word64 where
  mkX8 (W64# x0) (W64# x1) (W64# x2) (W64# x3) (W64# x4) (W64# x5) (W64# x6) (W64# x7) = MkWord64X8WithVec256 (packWord64X4# (# x0, x1, x2, x3 #)) (packWord64X4# (# x4, x5, x6, x7 #))
  unpackX8 (MkWord64X8WithVec256 v0 v1) = case unpackWord64X4# v0 of (# x0, x1, x2, x3 #) -> case unpackWord64X4# v1 of (# x4, x5, x6, x7 #) -> (W64# x0, W64# x1, W64# x2, W64# x3, W64# x4, W64# x5, W64# x6, W64# x7)
  {-# INLINE mkX8 #-}
  {-# INLINE unpackX8 #-}
instance Broadcast X8 Word64 where
  broadcast (W64# x) = let !v = broadcastWord64X4# x in MkWord64X8WithVec256 v v
  {-# INLINE broadcast #-}
instance SelectableF X8 Word64 where
  selectF (MkBoolX8 !cond) (MkWord64X8WithVec256 x0 x1) (MkWord64X8WithVec256 y0 y1) = MkWord64X8WithVec256 (selectWord64X4# (cond `unsafeShiftR` 0) x0 y0) (selectWord64X4# (cond `unsafeShiftR` 4) x1 y1)
  {-# INLINE selectF #-}
instance (i0 < 8, i1 < 8, i2 < 8, i3 < 8, i4 < 8, i5 < 8, i6 < 8, i7 < 8, ShuffleMany Word64X4# [i0, i1, i2, i3], ShuffleMany Word64X4# [i4, i5, i6, i7]) => UnaryShuffle [i0, i1, i2, i3, i4, i5, i6, i7] X8 Word64 where
  unaryShuffle (MkWord64X8WithVec256 x0 x1) = let { sources = \case { 0 -> x0; _ -> x1 } } in MkWord64X8WithVec256 (shuffleMany# @_ @_ @[i0, i1, i2, i3] sources) (shuffleMany# @_ @_ @[i4, i5, i6, i7] sources)
  {-# INLINE unaryShuffle #-}
instance (i0 < 16, i1 < 16, i2 < 16, i3 < 16, i4 < 16, i5 < 16, i6 < 16, i7 < 16, ShuffleMany Word64X4# [i0, i1, i2, i3], ShuffleMany Word64X4# [i4, i5, i6, i7]) => BinaryShuffle [i0, i1, i2, i3, i4, i5, i6, i7] X8 Word64 where
  binaryShuffle (MkWord64X8WithVec256 x0 x1) (MkWord64X8WithVec256 x2 x3) = let { sources = \case { 0 -> x0; 1 -> x1; 2 -> x2; _ -> x3 } } in MkWord64X8WithVec256 (shuffleMany# @_ @_ @[i0, i1, i2, i3] sources) (shuffleMany# @_ @_ @[i4, i5, i6, i7] sources)
  {-# INLINE binaryShuffle #-}
instance EquatableF X8 Word64 where
  eqF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (eqWord64X4# u0 v0)) .|. (fromIntegral (eqWord64X4# u1 v1) `unsafeShiftL` 4)
  {-# INLINE eqF #-}
instance OrderedF X8 Word64 where
  ltF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkBoolX8 $ (fromIntegral (ltWord64X4# u0 v0)) .|. (fromIntegral (ltWord64X4# u1 v1) `unsafeShiftL` 4)
  leF !x !y = complementF (ltF y x)
  gtF !x !y = ltF y x
  geF !x !y = complementF (ltF x y)
  {-# INLINE ltF #-}
...
instance MinMaxF X8 Word64 where
  minF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (minWord64X4# u0 v0) (minWord64X4# u1 v1)
  maxF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (maxWord64X4# u0 v0) (maxWord64X4# u1 v1)
  minimumNumberF = minF
  maximumNumberF = maxF
  {-# INLINE minF #-}
  {-# INLINE maxF #-}
...
instance NumF X8 Word64 where
  plusF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (plusWord64X4# u0 v0) (plusWord64X4# u1 v1)
  minusF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (minusWord64X4# u0 v0) (minusWord64X4# u1 v1)
  timesF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (timesWord64X4# u0 v0) (timesWord64X4# u1 v1)
...
instance BooleanF X8 Word64 where
  andF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (andWord64X4# u0 v0) (andWord64X4# u1 v1)
  orF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (orWord64X4# u0 v0) (orWord64X4# u1 v1)
  xorF (MkWord64X8WithVec256 u0 u1) (MkWord64X8WithVec256 v0 v1) = MkWord64X8WithVec256 (xorWord64X4# u0 v0) (xorWord64X4# u1 v1)
  complementF (MkWord64X8WithVec256 u0 u1) = MkWord64X8WithVec256 (complementWord64X4# u0) (complementWord64X4# u1)
  {-# INLINE andF #-}
  {-# INLINE orF #-}
  {-# INLINE xorF #-}
  {-# INLINE complementF #-}
instance BitShiftF X8 Word64 where
  shiftLF (MkWord64X8WithVec256 u0 u1) (I# i) = MkWord64X8WithVec256 (shiftLWord64X4# u0 i) (shiftLWord64X4# u1 i)
  shiftRF (MkWord64X8WithVec256 u0 u1) (I# i) = MkWord64X8WithVec256 (shiftRWord64X4# u0 i) (shiftRWord64X4# u1 i)
  {-# INLINE shiftLF #-}
  {-# INLINE shiftRF #-}
instance EnumFromZero_ X8 Word64 where
#if MIN_VERSION_GLASGOW_HASKELL(9, 8, 1, 0)
  enumFromZero = MkWord64X8WithVec256 (packWord64X4# (# 0#Word64, 1#Word64, 2#Word64, 3#Word64 #)) (packWord64X4# (# 4#Word64, 5#Word64, 6#Word64, 7#Word64 #))
#else
  enumFromZero = mkX8 0 1 2 3 4 5 6 7
#endif
  -- {-# INLINE enumFromZero #-}
instance MultiPrim X8 Word64 where
  indexByteArraySIMD# ba i = MkWord64X8WithVec256 (indexWord64ArrayAsWord64X4# ba i) (indexWord64ArrayAsWord64X4# ba (i +# 4#))
  readByteArraySIMD# mba i s0 = case readWord64ArrayAsWord64X4# mba i s0 of (# s1, v0 #) -> case readWord64ArrayAsWord64X4# mba (i +# 4#) s1 of (# s2, v1 #) -> (# s2, MkWord64X8WithVec256 v0 v1 #)
  writeByteArraySIMD# mba i (MkWord64X8WithVec256 v0 v1) s0 = case writeWord64ArrayAsWord64X4# mba i v0 s0 of s1 -> writeWord64ArrayAsWord64X4# mba (i +# 4#) v1 s1
  {-# INLINE indexByteArraySIMD# #-}
  {-# INLINE readByteArraySIMD# #-}
  {-# INLINE writeByteArraySIMD# #-}
instance MultiStorable X8 Word64 where
  peekElemOffSIMD (Ptr addr) (I# i) = IO (\s0 -> case readWord64OffAddrAsWord64X4# addr i s0 of (# s1, v0 #) -> case readWord64OffAddrAsWord64X4# addr (i +# 4#) s1 of (# s2, v1 #) -> (# s2, MkWord64X8WithVec256 v0 v1 #))
  pokeElemOffSIMD (Ptr addr) (I# i) (MkWord64X8WithVec256 v0 v1) = IO (\s0 -> case writeWord64OffAddrAsWord64X4# addr i v0 s0 of s1 -> case writeWord64OffAddrAsWord64X4# addr (i +# 4#) v1 s1 of s2 -> (# s2, () #))
  {-# INLINE peekElemOffSIMD #-}
  {-# INLINE pokeElemOffSIMD #-}
